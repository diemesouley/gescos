...
// Returns the private 'App\Repository\DetailRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DetailRepository.php';

return $this->privates['App\\Repository\\DetailRepository'] = new \App\Repository\DetailRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
