...
// Returns the private 'App\Repository\NouvCommFournisseurRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/NouvCommFournisseurRepository.php';

return $this->privates['App\\Repository\\NouvCommFournisseurRepository'] = new \App\Repository\NouvCommFournisseurRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
