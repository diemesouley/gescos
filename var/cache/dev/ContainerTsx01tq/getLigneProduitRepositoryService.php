...
// Returns the private 'App\Repository\LigneProduitRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LigneProduitRepository.php';

return $this->privates['App\\Repository\\LigneProduitRepository'] = new \App\Repository\LigneProduitRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
