...
// Returns the private 'App\Repository\LigneSortieRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LigneSortieRepository.php';

return $this->privates['App\\Repository\\LigneSortieRepository'] = new \App\Repository\LigneSortieRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
